...
export function EdgesList({ edges, onOpen, onRefresh }: EdgesListProps): JSX.Element {
    ...
    <div className="page">
      ...
      <section className="card">
        <header className="card__head">
          <h3 className="h3">Enroll edge</h3>
          <span className="mono" style={{ fontSize: 11, color: "var(--muted)" }}>
            POST /v1/edges
          </span>
        </header>
        <div className="card__body" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr auto", gap: 8, alignItems: "end" }}>
