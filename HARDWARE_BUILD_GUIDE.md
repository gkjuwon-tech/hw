...
>
> **글자 읽기 싫으면 그림만 봐도 됨.** 형이 핵심 단계마다 그림 그려놨음 (전체 흐름 / 발주 지도 / 발주 타임라인 / 깔판 단면 / 격자 치수 / 멀티미터 검사 / PCB 연결 / Edge 셋업 5단계). 그림에 화살표랑 숫자 다 있음. 진짜 그림만 보고 따라해도 1대 나오게 해놨음. 제발 그림이라도 봐.
>
> ---
>
...
- [ ] 라미네이팅 (30분)
- [ ] **Jetson 도착 → JetPack 플래시 + 첫 부팅** (7.1, 1시간 대부분 대기)
